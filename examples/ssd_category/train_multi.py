...
from chainer_epic_kitchens.datasets import epic_kitchens_bbox_category_names
from chainer_epic_kitchens.datasets import EpicKitchensBboxDataset
from chainer_epic_kitchens.datasets import get_epic_kitchens_category
...
class Transform(object):
    ...
    def __call__(self, in_data):
        ...
        img -= self.mean
        mb_loc, mb_label = self.coder.encode(bbox, cat_label)
...
def main():
    ...
    if args.model == 'ssd300':
        model = SSD300(
            n_fg_class=len(epic_kitchens_bbox_category_names),
